...
${formData.message}
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 50 && !hasScrolled) { // Only set if we haven't manually hidden it
        setShowScrollIndicator(false)
        setHasScrolled(true)
      }
    }
    ...
    <div className={styles.container}>
      ...
      <nav className={styles.navbar}>
        <a href="/" className={styles.navBrand} onClick={scrollToTop}>
          <img src="/smallseyss-logo.svg" className={styles.logoIcon} alt="Smallseyss Logo" />
        </a>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <img src="/smallseyss-logo.svg" className={styles.heroLogo} alt="Smallseyss Logo" />
          <h1 className={styles.heroTitle}>Anna Seyss</h1>
          <p className={styles.heroSubtitle}>smallseyss.ink</p>
          <p className={styles.heroDescription}>handwritten lettering, tiny and fine line tattoos with love in Berlin</p>
